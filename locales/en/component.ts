export default {
    home: {
        ...
        features: {
            ...
            privacyProtection: 'Data Security',
            privacyProtectionDesc: 'This platform provides professional mental health assessment services. If you use the comprehensive assessment feature, the relevant data will be stored on the server solely to generate your report and will not be used for any other purpose.',
        ...
        hero: {
            ...
            localProcessing: 'Completely Free',
            ...
            noDataCollection: 'Results are for reference only and do not constitute a medical diagnosis. Comprehensive assessment results are securely stored solely to generate your report.',
        },
        sponsors: {
    ...
    survey: {
        ...
        description: 'This comprehensive assessment includes multiple standardized psychological scales. Your scores will be shown upon completion.',
        nameLabel: 'Your name',
        namePlaceholder: 'Enter your name or nickname',
        nameRequired: 'Please enter your name first',
        includes: 'This assessment includes {count} scales:',
        startSurvey: 'Start Assessment',
        saving: 'Saving your results…',
        resultsTitle: 'Assessment Results',
        greeting: '{name}, here are your scores:',
        savedSuccess: '✓ Results saved successfully',
        savedSkipped: '(Database not configured – results shown on this page only)',
        scoringBriefTitle: 'Scoring Standards (Brief)',
        scoringStandard_scl90: 'SCL-90: total score is the sum of 90 item ratings; higher scores indicate heavier overall symptom burden.',
        scoringStandard_sds: 'SDS: standard score = raw score × 1.25; a score of 50 is commonly used as a screening reference cutoff.',
        scoringStandard_sas: 'SAS: standard score = raw score × 1.25; a score of 50 is commonly used as a screening reference cutoff.',
        scoringStandard_hcl32: 'HCL-32: total score equals the count of "Yes" responses; 14 or above often indicates possible hypomanic features.',
        scoringStandard_asrs: 'ASRS: total score is the sum of 18 frequency ratings; more positive items in Part A suggest higher ADHD symptom risk.',
        resultsTableTitle: 'Comprehensive Results Table',
        columnCn: 'CN',
        viewAllResults: 'View All Results',
        scaleIntroTitle: 'Scale Background (with time range)',
        scaleInstructionsTitle: 'Instructions (with time range)',
        allResultsTitle: 'All Comprehensive Survey Results',
        allResultsDesc: 'The result column is shown as "Scale Severity(score)".',
        allResultsLoading: 'Loading result data…',
        allResultsName: 'Name',
        allResultsResult: 'Result',
        allResultsTime: 'Time',
        allResultsEmpty: 'No saved survey results yet.',
        allResultsSortLabel: 'Sort',
        allResultsSortDesc: 'By time: newest first',
        allResultsSortAsc: 'By time: oldest first',
        resultTableScale: 'Scale',
        resultTableScore: 'Score',
        resultTableResult: 'Result',
        resultTableDetail: 'Detailed Result',
        openDetailInNewTab: 'Open in New Tab',
        restartAll: 'Restart All',
        restartCurrentScale: 'Restart This Scale',
        ...
        viewDetail: 'View Detailed Interpretation',
        exploreMore: 'Explore More Scales',
        backHome: 'Back to Home',
        prevPage: 'Previous Page',
        nextPage: 'Next Page',
        pageInfo: 'Page {currentPage} of {totalPages}',
        progressInfo: 'Scale {current} of {total}',
        nextQuestionnaire: 'Next Scale',
        submit: 'Submit',
        answerAll: '{remaining} question(s) still unanswered – please complete all before continuing',
    },
    navBar: {
        title: 'LXScale',
        introduce: 'Intro',
        questionsList: 'Qnaire',
        comprehensiveSurvey: 'Full Survey',
        rescues: 'Repo',
    },
} as const;
